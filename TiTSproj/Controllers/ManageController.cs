...
namespace TiTSproj.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        private DaneUzytkownika DaneUzytkownika;
        ...
        public ManageController(Model1 context, IMailService mailService)
        {
            this.db1 = context;
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            {
                DaneUzytkownika = userId.DaneUzytkownika
        ...
        public ActionResult ListaZamowien()
        {
            ...
            if (isAdmin)
            {
                zamowieniaUzytkownika = db1.Zamowienia.Include("PozycjaZamowienia").OrderByDescending(o => o.DataDodania).ToArray();
            }
            else
            {
                var userId = User.Identity.GetUserId();
                zamowieniaUzytkownika = db1.Zamowienia.Where(o => o.UserId == userId).Include("PozycjaZamowienia").OrderByDescending(o => o.DataDodania).ToArray();
            }
        ...
        {
            Zamowienie zamowienieDoModyfikacji = db1.Zamowienia.Find(zamowienie.ZamowienieID);
